...
main () {
  ...
  devExt = (PDEVEXT*)malloc(sizeof(struct devext)); 
  devExt->WriteListHeadVa = (PREQ*) malloc(sizeof(struct req));
  request = (PREQ*) malloc (sizeof(struct req));
  irp = (PIRP*) malloc (sizeof(struct irp));
