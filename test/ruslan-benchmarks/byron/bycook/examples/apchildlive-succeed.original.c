...
int handled_conn;
unsigned int pc;
int __phi() { return CAG(CIMP(CAP(do_ACCEPT>0),CEF(CAP(handled_conn>0)))); }

int accept_mutex_off() { return nondet(); }
int unixd_setup_child() { return nondet(); }
int APR_STATUS_IS_EINTR(int a) { return nondet(); }
int accept_mutex_on() { return nondet(); }
int SAFE_ACCEPT(int a) { return nondet(); }
int clean_child_exit(int a) { return nondet(); }
...
int apr_pollset_poll(int pollset, int a, int *numdesc, int *pdesc) { return nondet(); }
int ap_run_create_connection(int ptrans, int ap_server_conf, int csd, int my_child_num, int sbh, int bucket_alloc) { return nondet(); }
