...
unsigned int pc;
 inline int __phi() { return CAG(CIMP(CAP(keA==1),CAF(CAP(keR==1)))); }
...
int __rho_91_;
 ...
 inline void KeAcquireSpinLock(int * lp, int * ip) {
   /* (*lp) = 1; */
   /* (*ip) = irql; */
}

 inline void KeReleaseSpinLock(int * lp, int i) {
   /* (*lp) = 0; */
   /* irql = i; */
}

 inline void IoAcquireCancelSpinLock(int * ip) {
   /* csl = 1; */
   /* (*ip) = irql; */
}

 inline void IoReleaseCancelSpinLock(int ip) {
   /* csl = 0; */
   /* irql = ip; */
}

 inline void IoMarkIrpPending(int x) {}

// This could be modelled in more detail
 inline void RemoveReferenceAndCompleteRequest(int x,int y) {}

// This could be modelled in more detail
 inline void RemoveReferenceForDispatch(int x) {}

// This could be modelled in more detail
 inline void ProcessConnectionStateChange(int x) {}
